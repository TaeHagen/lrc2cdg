...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'lrc2cdg.wast';
  var wasmBinaryFile = 'lrc2cdg.wasm';
  var asmjsCodeFile = 'lrc2cdg.temp.asm.js';
...
STATICTOP = STATIC_BASE + 33968;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_lrc2cdg_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var real___GLOBAL__sub_I_lrc2cdg_cpp = asm["__GLOBAL__sub_I_lrc2cdg_cpp"]; asm["__GLOBAL__sub_I_lrc2cdg_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_lrc2cdg_cpp.apply(null, arguments);
};
...
var real__convlrc2cdgjs = asm["_convlrc2cdgjs"]; asm["_convlrc2cdgjs"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__convlrc2cdgjs.apply(null, arguments);
};
...
var __GLOBAL__sub_I_lrc2cdg_cpp = Module["__GLOBAL__sub_I_lrc2cdg_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_lrc2cdg_cpp"].apply(null, arguments) };
...
var _convlrc2cdgjs = Module["_convlrc2cdgjs"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_convlrc2cdgjs"].apply(null, arguments) };
